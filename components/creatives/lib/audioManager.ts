...
class AudioManager {
  ...
  private init() {
    ...
    this.music = new Howl({
      src: [`/creatives/sfx/BG_music_ST.mp3?v=${cb}`],
      loop: true,
      volume: 0,
    ...
    this.hoverSound = new Howl({
      src: [`/creatives/sfx/hover-sound.mp3?v=${cb}`],
      loop: false,
      volume: 0.18,
      preload: true
    });
    ...
    this.popSound = new Howl({
      src: [`/creatives/sfx/pop-sound.mp3?v=${cb}`],
      loop: false,
      volume: 0.35,
      preload: true
    });
    ...
    this.errorSound = new Howl({
      src: [`/creatives/sfx/404-error-sound.mp3?v=${cb}`],
      loop: false,
      volume: 0.4,
      preload: true
    });
    ...
    this.whooshSound = new Howl({
      src: [`/creatives/sfx/whoosh-sound.mp3?v=${cb}`],
      loop: false,
      volume: 0.3,
      preload: true
    });
