                        ...
                        >
                            ...
                            {(activeItem.name || activeItem.role) && (
                                <div className="mt-6 pt-4 border-t border-neutral-200 dark:border-neutral-800">
                                    <p className="font-semibold text-neutral-900 dark:text-white text-sm">{activeItem.name}</p>
                                    <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5 uppercase tracking-wider">
                                        {activeItem.role} {activeItem.company && <span className="text-[#ab71f8] font-bold"> • {activeItem.company}</span>}
                                    </p>
                                </div>
                            )}
                        </motion.div>
