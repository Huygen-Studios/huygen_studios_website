...
console.log('Supabase URL found:', supabaseUrl ? `${supabaseUrl.substring(0, 10)}...` : 'empty');
console.log('Supabase Key found:', supabaseAnonKey ? 'exists (hidden)' : 'empty');
...
if (!isValidUrl || !supabaseAnonKey) {
  console.warn('Supabase credentials missing or invalid. Contact form will not save to database.')
}
